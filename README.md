...
- Initially began by fitting basic models like Logistic Regression and KNN as these models are simple and have very good interpretability.  
- The results were not promising enough, so proceeded to fit ensemble models using boosting and bagging techniques.  
